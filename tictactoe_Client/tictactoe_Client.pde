...
void draw() {
  ...
  while (r < 3) {
    ...
    //are you winning
    if (board[0][c] == O  && board[1][c] == O && board[2][c] == O || board[0][0] == O  && board[0][1] == O && board[0][2] == O || board[1][0] == O  && board[1][1] == O && board[1][2] == O || board[2][0] == O  && board[2][1] == O && board[2][2] == O || board[0][0] == O  && board[1][1] == O && board[2][2] == O || board[0][2] == O  && board[1][1] == O && board[2][0] == O) {
      fill(255);
      textSize(50);
      text("O wins", width/2, height/2);
    } else if (board[0][c] == X  && board[1][c] == X && board[2][c] == X || board[0][0] == X  && board[0][1] == X && board[0][2] == X || board[1][0] == X  && board[1][1] == X && board[1][2] == X || board[2][0] == X  && board[2][1] == X && board[2][2] == X || board[0][0] == X  && board[1][1] == X && board[2][2] == X || board[0][2] == X  && board[1][1] == X && board[2][0] == X) {
      fill(255);
      textSize(50);
...
void mouseReleased() {
  ...
  int col = mouseX/100;
  if (mouseY < 300) {
    if (board[row][col] == EMPTY && board[row][col] != X && board[row][col] != O) {
      board[row][col] = O;
